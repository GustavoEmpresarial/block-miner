(function initLayout() {
  ...
  const LAYOUT_CACHE_KEY = "bm_layout_internal_navbar_v2";
  const LEGACY_LAYOUT_CACHE_KEYS = ["bm_layout_internal_navbar_v1"];
  const LAYOUT_CACHE_MAX_AGE_MS = 15 * 60 * 1000;

  for (const legacyKey of LEGACY_LAYOUT_CACHE_KEYS) {
    try {
